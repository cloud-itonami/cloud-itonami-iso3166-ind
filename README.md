# cloud-itonami-iso3166-ind

Open ISO 3166 Blueprint for **IND**: India.
...
tax registration, and local-content rules in India, so the operator
...
- **Not the government of India.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to India-licensed counsel
...
(ISO 3166 `IND`). Required capabilities:
