...
`cloud-itonami-iso3166-ind` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
India-licensed counsel or a registered agent for whatever licensed
representation the law of India requires for public-procurement
filings.
