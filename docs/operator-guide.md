...
2. Register the client's intake: business type, target public function,
   prior filing history in India if any.
3. Run the advisor in read-only mode against GeM (Government e-Marketplace) seller registration.
...
- named referral relationship with India-licensed counsel or a
...
a working referral relationship with India-licensed counsel or a
registered agent for whatever licensed representation the law of
India requires for actual public-procurement filings.
